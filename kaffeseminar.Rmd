...
# img3_path=paste0(here(),"/img/SystematicMap.png")
# knitr::include_graphics(img3_path)

```
![](img/SystematicMap.png)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
# img3_path=paste0(here(),"/img/SystematicReview.png")
# knitr::include_graphics(img3_path)

```
![](img/SystematicReview.png)
...
# img3_path=paste0(here(),"/img/That-jerk-throwing-weight.jpg")
# knitr::include_graphics(img3_path)

```

![](img/That-jerk-throwing-weight.jpg)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
# img3_path=paste0(here(),"/img/DecisionModel.png")
# knitr::include_graphics(img3_path)

```

![](img/DecisionModel.png)
---
...
# img3_path=paste0(here(),"/img/logo.png")
# knitr::include_graphics(img3_path)
...
# Small fig.width
# 
# img1_path=paste0(here(),"/img/Buck.jpg")
...
# img1_path=paste0(here(),"/img/jfr312484-fig-0002-m.png")
# img2_path=paste0(here(),"/img/jfr312484-fig-0004-m.jpg")
# knitr::include_graphics(img1_path)

```

![](img/jfr312484-fig-0002-m.png)
...
#img1_path=paste0(here(),"/img/jfr312484-fig-0002-m.png")
#img2_path=paste0(here(),"/img/unnamed-chunk-309-1.png")
#knitr::include_graphics(img2_path)
```
![](img/unnamed-chunk-309-1.png)
---

```{r, echo=FALSE, warning=FALSE, message=FALSE}

#img1_path=paste0(here(),"/img/jfr312484-fig-0002-m.png")
#img2_path=paste0(here(),"/img/forest_bayesian.png")
#knitr::include_graphics(img2_path)
```

![](img/forest_bayesian.png)
...
#img1_path=paste0(here(),"/img/jfr312484-fig-0002-m.png")
#img2_path=paste0(here(),"/img/1500x500.jpg")
#knitr::include_graphics(img2_path)
```
